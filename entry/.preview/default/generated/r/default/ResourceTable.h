...
const int32_t MEDIA_BANNER_CALENDAR = 0x01000016;
const int32_t MEDIA_BANNER_EXAM = 0x01000019;
const int32_t MEDIA_BANNER_INTERNSHIP = 0x01000017;
const int32_t MEDIA_BANNER_SELECTION = 0x01000018;
const int32_t MEDIA_FOREGROUND = 0x01000003;
const int32_t MEDIA_JISHIBEN = 0x01000015;
